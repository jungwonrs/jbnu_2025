...
EVAL_PY = "watermark_experiment_final.py"
LOG_PATH = Path("results.txt")


GRID = {
    "LAM_Z" : [0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 1.0, 2.0],
    "LAM_J" : [0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 1.0, 2.0],
    "IMP_GAIN" : [1.0, 2.0, 5.0, 10.0],
    "WM_STRENGTH" : [0.005,0.01, 0.02, 0.05, 0.1, 0.3, 0.4, 0.5],
}
