...
def coco_image_road(img_count):
    ...
    random_image_ids = random.sample(all_img_ids, img_count)
...
def train_inn(img_count, batch_size, epoches):
    ...
    '''
    dataset = coco_image_road(img_count)
...
train_inn(img_count, batch_size, epoches)